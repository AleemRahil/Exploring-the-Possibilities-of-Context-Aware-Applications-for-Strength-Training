...
import sys
sys.path.append('C:/Users/Aleem/OneDrive/Documents/GitHub/FitnessTracking App/src/features')
...
for col in predictor_columns:
    df_lowpass = LowPass.low_pass_filter(df_lowpass, col, fs, cutoff_frequency=cutoff, order=5)
...
FrequencyAbstraction = FourierTransformation()

fs = int(1000/200)
ws = int(2800/200)

df_freq = FrequencyAbstraction.abstract_frequency(df_freq, ['acc_y'], ws, fs)
...
for s in df_freq['set'].unique():
    ...
    subset = FrequencyAbstraction.abstract_frequency(subset, predictor_columns, ws, fs)
