...
feature_set_2 = list(set(feature_set_1 + pca_features + square_features))
...
fig, ax = plt.subplots(figsize=(10, 5))
df_train['label'].value_counts().plot(kind='bar', ax=ax, color='dodgerblue', label='Total')
...
class_test_y,
class_train_prob_y,
class_test_prob_y) = learner.feedforward_neural_network(
